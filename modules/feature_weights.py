...
class Learner:
    ...
    def shift_mask_data(self, X, Y, upper_percentile, lower_percentile, n_fwd_days):
    ...
    def feature_importance_adaboost(self, n_fwd_days, close, all_factors,n_estimators, train_size,
        ...
        clf = ensemble.AdaBoostClassifier(n_estimators=n_estimators) # n_estimators controls how many weak classifiers are fi
