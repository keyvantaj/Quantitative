...
class AbstractOptimalHoldings(ABC):
    ...
    @staticmethod
    def _get_risk(weights, factor_betas, alpha_vector_index, factor_cov_matrix, idiosyncratic_var_vector):
...
class OptimalHoldingsRegularization(OptimalHoldings):
    ...
    def __init__(self, lambda_reg=0.5, risk_cap=0.05, factor_max=10.0, factor_min=-10.0, weights_max=0.2,
                 weights_min=-0.2):
        super().__init__(risk_cap, factor_max, factor_min, weights_max, weights_min)
